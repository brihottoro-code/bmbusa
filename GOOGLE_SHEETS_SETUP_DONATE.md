# Google Sheets Integration Setup Guide - Donation Form

This guide will help you set up the Google Sheets integration for the Donation Form.
...
2. Open the spreadsheet with ID: `1228bBof9Ygb4fesUBzFNhR3ZXaagKVX6SHQh-hIdag4`
...
4. Configure the deployment:
   - **Description**: "Donation Form Submission Handler"
...
1. Add to your `.env.local` file (for local development):
   ```
   NEXT_PUBLIC_GOOGLE_SCRIPT_URL_DONATE=https://script.google.com/macros/s/YOUR_SCRIPT_ID/exec
   ```

2. Add to GitHub Secrets (for production):
   - Go to your GitHub repository Settings > Secrets and variables > Actions
   - Click "New repository secret"
   - Name: `NEXT_PUBLIC_GOOGLE_SCRIPT_URL_DONATE`
   - Value: Your Google Apps Script Web App URL
   - Click "Add secret"

3. Replace `YOUR_SCRIPT_ID` with the actual ID from your deployed script URL

4. Restart your development server if running

#### Option B: Hardcode the URL (For Testing)

1. Open `app/donate/page.tsx`
2. Find the line: `const GOOGLE_SCRIPT_URL_DONATE = process.env.NEXT_PUBLIC_GOOGLE_SCRIPT_URL_DONATE || ''`
3. Replace with: `const GOOGLE_SCRIPT_URL_DONATE = 'https://script.google.com/macros/s/YOUR_SCRIPT_ID/exec'`
...
2. Submit the form
3. Check your Google Sheet - a new row should appear in the "donates" worksheet
4. Check your email (brihottoro@gmail.com) - you should receive a notification

## Features

- ✅ **Form Data Storage**: All donations are saved to Google Sheets
- ✅ **Email Notifications**: Receive email notifications with donation details
- ✅ **Automatic Organization**: Donations are organized by timestamp
- ✅ **Currency Formatting**: Amounts are automatically formatted as currency
- ✅ **Anonymous Donations**: Supports anonymous donation option
...
- **Check sheet name**: Ensure the worksheet name matches "donates" (case-sensitive)
